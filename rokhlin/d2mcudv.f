        IMPLICIT REAL *8 (A-H,O-Z)
         complex *16 a(2,2),ima,u(2,2),v(2,2),
...
ccc        a(2,2)=1.0d-17
        a(1,2)=1.0d-17
         call prin2('a as created*',a,8)
c 
         eps=1.0d-15
         call oneuv(ier,a,rlam,u,v)
cccc         call prin2('after oneuv, u=*',u,8)
cccc         call prin2('after oneuv, v=*',v,8)
cccc         call prin2('after oneuv, rlam=*',rlam,2)
c 
...
c 
        ...
        rlams(1,2)=0
        rlams(2,1)=0
        call d2mprodc(u,a,w1)
        call d2mprodc(w1,v,w2)
        call prin2('u a v =*',w2,8)
c 
c 
...
cccc        if(i .lt. n**2/2) cb(i)=0
        cb2(i)=cb(i)
 1200 continue
        call prin2('matrix as created*',cb,n*n*2)
c 
...
c 
        ...
        t1= second(tt)
        ifuv=1
        call d2mcudv(cb,n,uu,vv,eps,ifuv,numrows)
ccc        call d2mudv(b,n,uuu,vvv,eps,ifuv,numrows)
        t2= second(tt)
         call prin2('and CPU time is*',t2-t1,1)
         call prinf('and numrows=*',numrows,1)
        call prin2('singular values after d2mcudv*',cb,n*2)
cccc        call prin2('matrix after d2mudv*',cb,n*n*2)
cccc        call prin2('uu after d2mudv*',uu,n*n*2)
cccc        call prin2('vv after d2mudv*',vv,n*n*2)
c 
c       now, test the svd
c 
...
c 
        ...
        implicit real *8 (a-h,o-z)
        save
        complex *16 s(1),u(n,n),v(n,n),w(n,n),b(n,n),
     1      w2(n,n)
c 
...
c 
 ...
 1200 continue
        w(i,i)=s(i)
 1400 continue
cccc         call prin2('in svdtes, w=*',w,n*n*2)
c 
c       construct all proper products
c 
        call matmul(u,w,w2,n)
         call prin2('after first matmul, w2=*',w2,8)
        call matmul(w2,v,w,n)
cccc          call prin2('and b recomputed from svd*',w,n*n*2)
cccc          call prin2('while b *',b,n*n*2)
c 
...
c 
        ...
        do 1800 i=1,n
        do 1600 j=1,n
        dd=dd+(b(j,i)-w(j,i))*dconjg(b(j,i)-w(j,i))
 1600 continue
 1800 continue
        dd=dsqrt(dd)
...
c 
        ...
        implicit real *8 (a-h,o-z)
        save
        complex *16 a(n,n),b(n,n),c(n,n),d
        do 2000 i=1,n
        do 1800 j=1,n
        d=0
        do 1400 k=1,n
