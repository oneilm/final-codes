...
c 
        call grmsol(a,n,x,y,rcond)
  
        call prin2('after grmsol, rcond=*',rcond,1)
  
        call prin2('after grmsol, y=*',y,n)
...
c 
 ...
 2400 continue
c 
          call prin2('and the difference*',z,n)
...
c 
c 
        subroutine grmsol(b,n,x,y,rcond)
        implicit real *8 (a-h,o-z)
        save
...
c 
c 
        subroutine grmsol0(b,n,x,rnorms,rcond)
        implicit real *8 (a-h,o-z)
        save
        real *8 b(n,n),cd,x(1)
        dimension rnorms(1)
