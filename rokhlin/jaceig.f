...
c 
c 
        subroutine eigtest(a,n)
        implicit real *8 (a-h,o-z)
        save
        dimension a(n,n),b(100000),u(100 000),
     1      y(1000),eig2(1000),b2(100 000)
c 
...
c 
 ...
 1400 continue
        ...
        call memmove(a,b,n**2)
        call memmove(a,b2,n**2)
  
        call prin2('test matrix b as constructed*',b,n*n)
  
  
  
c 
c       diagonalize the test matrix
c 
        ifvect=1
        eps=1.0d-14
        call jaceig(b,n,eps,ifvect,u,nelems)
  
        call prin2('after jackeig, eigenvalues are*',b,n)
        call prin2('after jackeig, eigenvectors are*',u,n*n)
        call prinf('after jackeig, nelems=*',nelems,1)
c 
c       apply the matrix b to each of the putative eigenvectors;
c       normalize the result, and see if e get the eigenvector back
c 
        do 3000 k=1,n
  
  
        call matvec(b2,u((k-1)*n+1),y,n,n)
  
        d=0
c 
        eig2(k)=y(1)/u( (k-1)*n+1)
 3000 continue
  
  
        call prin2('and eig2=*',eig2,n)
        call prin2('while b=*',b,n)
  
        do 3200 i=1,n
        b(i)=b(i)-eig2(i)
 3200 continue
  
        call prin2('and the differences are*',b,n)
...
c 
 2600 continue
 2800 continue
        call prinf('in jaceig, ijk=*',ijk,1)
c 
        do 3400 i=2,n
        do 3200 j=1,n-1
        a(i,j)=a(j,i)
...
c 
 ...
 5600 continue
c 
        call prin2('before sorting, a(1)=*',a(1,1),n)
c 
        do 6000 i=1,n
c 
        do 5800 j=4,n-1
