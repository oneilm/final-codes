...
c 
        ...
        implicit real *8 (a-h,o-z)
        save
        dimension a(n,m),v(m,n),w(50 000),t(50 000),
     1      c(n,m),rnorms(1000),tt(1000),a2(n,m),
     2      x(1000),y(1000),work(1000),x2(1000)
c 
...
c 
        ...
        call leastsq(a,u,w,t,n,m,ncols,rnorms,
     1    eps,v)
c 
        call prinf('after leastsq, ncols=*',ncols,1)
        call prin2('after leastsq, rnorms=*',rnorms,ncols)
        call prin2('after leastsq, a=*',a,n*m)
        call prin2('after leastsq, u=*',u,ncols*n)
        call prin2('after leastsq, w=*',w,ncols*m)
        call prin2('after leastsq, t=*',t,ncols**2)
  
cccc           if(2 .ne. 3) stop
c 
c       test the accuracy
c 
        call mulback(u,w,t,n,ncols,m,c,v)
  
          call prin2('and after mulback, c=*',c,n*m)
...
c 
 ...
 3200 continue
c 
        call prin2('checking the inverter, x=*',x,m)
  
        call matvec(a2,x,y,n,m)
  
  
        call prin2('checking the inverter, y=*',y,m)
  
c 
        call leastsq2(u,w,t,n,m,ncols,y,x2,work)
  
        call prin2('checking the inverter, x2=*',x2,m)
...
c 
c 
        subroutine mulback(u,w,t,n,ncols,m,c,work)
        implicit real *8 (a-h,o-z)
        save
        dimension w(m,ncols),u(n,ncols),c(n,m),t(ncols,ncols),
     1      work(n,ncols)
c 
c       multiply u by t
c 
