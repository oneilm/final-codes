...
c 
 ...
 1800 continue
c 
         call prin2('before ortho1, a=*',a,n*n)
c 
c        invert the matrix a
c 
        call orthom(a,n,work,cond)
         call prin2('after corthom, cond=*',cond,1)
c 
cccc        call prin2('after ortho1, a=*',a,n*n)
c 
c        multiply a and its putative inverse
c 
        call matmul(c,a,b,n)
        call prin2('after matmul, b=*',b,n*n)
...
c       apply a to x
c 
        call orthom_matvec(c,n,x,y)
          call prin2('a x =*',y,n)
c 
c        apply inverse of a to x
c 
        call orthom_matvec(a,n,y,z)
         call prin2('z=*',z,n)
