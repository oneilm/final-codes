/* prini.f -- translated by f2c (version 20030320).
...
/* Subroutine */ int prini_0_(int n__, integer *ip1, integer *iq1, char *mes, 
	real *a, integer *n, doublereal *a2, E_fp a4, integer *ia, shortint *
	ia2, char *aa, ftnlen mes_len, ftnlen aa_len)
{
    /* Format strings */
    ...
    static cilist io___8 = { 0, 0, 0, fmt_1500, 0 };
    static cilist io___9 = { 0, 0, 0, fmt_1500, 0 };
    static cilist io___10 = { 0, 0, 0, fmt_1600, 0 };
    static cilist io___11 = { 0, 0, 0, fmt_1600, 0 };
    static cilist io___12 = { 0, 0, 0, fmt_1600, 0 };
    static cilist io___13 = { 0, 0, 0, fmt_1600, 0 };
    static cilist io___14 = { 0, 0, 0, fmt_2000, 0 };
...
/* Subroutine */ int prini_(integer *ip1, integer *iq1)
{
    return prini_0_(0, ip1, iq1, (char *)0, (real *)0, (integer *)0, (
	    doublereal *)0, (D_fp)0, (integer *)0, (shortint *)0, (char *)0, (
	    ftnint)0, (ftnint)0);
    }
...
/* Subroutine */ int prin_(char *mes, real *a, integer *n, ftnlen mes_len)
{
    return prini_0_(1, (integer *)0, (integer *)0, mes, a, n, (doublereal *)0,
	     (D_fp)0, (integer *)0, (shortint *)0, (char *)0, mes_len, (
	    ftnint)0);
    }
	...
	mes_len)
{
    return prini_0_(2, (integer *)0, (integer *)0, mes, (real *)0, n, a2, (
	    D_fp)0, (integer *)0, (shortint *)0, (char *)0, mes_len, (ftnint)
	    0);
    }

/* Subroutine */ int prinq_(char *mes, E_fp a4, integer *n, ftnlen mes_len)
{
    return prini_0_(3, (integer *)0, (integer *)0, mes, (real *)0, n, (
	...
	mes_len)
{
    return prini_0_(4, (integer *)0, (integer *)0, mes, (real *)0, n, (
	    doublereal *)0, (D_fp)0, ia, (shortint *)0, (char *)0, mes_len, (
	    ftnint)0);
    }
	...
	mes_len)
{
    return prini_0_(5, (integer *)0, (integer *)0, mes, (real *)0, n, (
	    doublereal *)0, (D_fp)0, (integer *)0, ia2, (char *)0, mes_len, (
	    ftnint)0);
    }
	...
	ftnlen aa_len)
{
    return prini_0_(6, (integer *)0, (integer *)0, mes, (real *)0, n, (
	    doublereal *)0, (D_fp)0, (integer *)0, (shortint *)0, aa, mes_len,
	     aa_len);
    }
	...
	mes_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___19 = { 0, 0, 0, fmt_1800, 0 };
    static cilist io___20 = { 0, 0, 0, fmt_1800, 0 };
