...
c 
        ...
        call qrdtest(a,n,m,u,v,w,lw,eps2,a2,a3)
...
c 
c 
        subroutine qrdtest(a,n,m,u,v,w,lw,eps,a2,a3)
        implicit real *8 (a-h,o-z)
c 
        save
        dimension a(n,m),u(n,m),v(m,n),w(1),s(2000),
     1      a2(n,m),w2(50 000),a3(n,m),tt(2000),
     2      s2(1000)
c 
...
c 
 ...
 1800 continue
c 
        call prin2('a as constructed*',a,n*m)
c 
...
c 
     ...
     1      w,lw,ltot)
        ...
        call prin2('after svdpivot, u=*',u,n*ncols)
        call prin2('after svdpivot, sigular values are*',s,ncols)
c 
c        now, conduct the abbreviated version of the SVD
c 
        call qrdpivot(a2,n,m,ncols2,eps,w2,s2)
c 
        call prinf('after qrdpivot, ncols2=*',ncols2,1)
c 
        call prin2('after qrdpivot, a2=*',a2,n*ncols)
        call prin2('after qrdpivot, s2=*',s2,ncols)
...
c 
cccc        call prinf('after qrpiv0, ncols=*',ncols,1)
...
c 
cccc        call prinf('after qrmudv, numrows=*',numrows,1)
c 
...
c 
        do 1700 k=i,m
c 
        d1=u(1,1)*a(i,k)+u(1,2)*a(j,k)
        d2=u(2,1)*a(i,k)+u(2,2)*a(j,k)
        a(i,k)=d1
        a(j,k)=d2
 1700 continue
c 
...
c 
 ...
 4200 continue
c 
       call qrmsvsrt(a(1,1),n,u,v,a(1,2),ifuv,nn)
        return
        end
c 
c 
...
c 
c 
        subroutine qrmsvsrt(s,n,u,v,iw,ifuv,nn)
        implicit real *8 (a-h,o-z)
        save
...
cccc        call prinf('and number of elementary transpositions is*',
cccc     1      ntran,1)
