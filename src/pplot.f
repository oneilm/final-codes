...
c
        ...
        write(iun87,'(a)') 'm = np.size(x)/2'
        write(iun87,'(a)') 'x.reshape(int(m),2)'
        write(iun87,'(a)') 'x1=x[:,0]'
        write(iun87,'(a)') 'x2=x[:,1]'
c
        write(iun87,'(a,a,a)') 'pt.plot(x1,x2,"',ls1,'")'
        write(iun87,'(a,a,a)') 'pt.title("', trim(title2), '")'
cccc        write(iun87, '(a)') 'pt.axes().set_aspect("equal")'
        write(iun87,'(a,a,a)') 'ax = pt.gca()'
        write(iun87,'(a,a,a)') 'ax.set_aspect("equal")'
...
c
        write(iun87,'(a,a,a)') 'x = np.loadtxt("',file8,'")'
        write(iun87,'(a)') 'm = np.size(x)/2'
        write(iun87,'(a)') 'x = x.reshape(int(m),2)'
        write(iun87,'(a)') 'x1=x[:,0]'
        write(iun87,'(a)') 'x2=x[:,1]'
c
        write(iun87,'(a)') ''
        write(iun87,'(a,a,a)') 'y = np.loadtxt("',file9,'")'
        write(iun87,'(a)') 'm = np.size(y)/2'
        write(iun87,'(a)') 'y = y.reshape(int(m),2)'
...
c
        ...
        write(iun87,'(a,a,a)') 'pt.title("', trim(title2), '")'
ccccc        write(iun87, '(a)') 'pt.axes().set_aspect("equal")'
        write(iun87,'(a,a,a)') 'ax = pt.gca()'
        write(iun87,'(a,a,a)') 'ax.set_aspect("equal")'
        write(iun87,'(a)') 'pt.show()'
...
c
        ...
        write(iun87,'(a)') 'm = np.size(z)/2'
        write(iun87,'(a)') 'z = z.reshape(int(m),2)'
